                ...
                <div id="popupForm" class="hidden absolute backdrop-blur-sm z-50 h-full w-full">
                    <div class="flex justify-center items-center h-full">
                        <div class="relative bg-black h-fit w-1/3">
                            ...
                            <div class="px-4 pb-4">
                                <form action="../API/kota_kabupaten.php" method="post">
                                    <div class="flex flex-col gap-4">
                                        <div class="flex border-b-[1px] border-white py-1">
                                            <label for="kodeprovinsi" class="my-auto w-1/3 text-white whitespace-nowrap text-sm">Kode Kota</label>
                                            <input class="outline-none w-full px-4 py-3 text-sm bg-black text-white" type="text" name="kode_kota" placeholder="Kode Kota">
                                        </div>
                                        <div class="flex border-b-[1px] border-white py-1">
                                            <label for="kodeprovinsi" class="my-auto w-1/3 text-white whitespace-nowrap text-sm">Nama Kota</label>
                                            <input class="outline-none w-full px-4 py-3 text-sm bg-black text-white" type="text" name="nama_kota" placeholder="Nama Kota">
                                        </div>
                                        <div class="flex border-b-[1px] border-white py-1">
                                            <label for="cars" class="my-auto w-1/3 text-white whitespace-nowrap text-sm">Provinsi</label>
                                            <select id="cars" class="w-full bg-black text-white" name="kode_provinsi">
                                                <?php $provinsi = $database->getReference('Provinsi')->getValue();
                                                ...
                                                <td class="text-center">
                                                    <form action="../API/kota_kabupaten.php" method="post">
                                                        <div class="flex justify-center gap-4">
                                                            <button name="edit" type="submit" class="cursor-pointer flex h-fit bg-green-600 text-white px-2 py-2" value="<?php echo $row['kode_kota']; ?>"><i class="w-10 flex my-auto fa fa-pen-to-square"></i>Edit</button>
                                                            <button name="delete" type="submit" class="cursor-pointer flex h-fit bg-red-600 text-white px-2 py-2" value="<?php echo $row['kode_kota']; ?>"><i class="w-10 flex my-auto fa fa-trash"></i>Delete</button>
                                                        </div>
                                                    </form>
                                                </td>
                                            </tr>
