                    ...
                    <div class="lg:mx-52 md:mx-24 mx-4 mb-4  overflow-auto h-full text-sm">
                        <div class="">
                            <form action="../API/provinsi.php" method="post">
                                <?php
                                $id = $_SESSION['edit'];
                                $getData = $database->getReference('Provinsi/' . $id)->getValue();
                                ?>
                                <!-- Text -->
                                <div class="flex py-4 border-b-[1px] border-black">
                                    <label class="text-sm w-1/2">Kode Provinsi</label>
                                    <input class="outline-none text-sm text-black w-full" value="<?php echo $getData['kode_provinsi']; ?>" type="text" name="kode_provinsi" placeholder="Kode Provinsi" disabled>
                                </div>
                                <div class="flex py-4 border-b-[1px] border-black">
                                    <label class="text-sm w-1/2">Nama Provinsi</label>
                                    <input class="outline-none text-sm text-black w-full" value="<?php echo $getData['nama_provinsi']; ?>" type="text" name="nama_provinsi" placeholder="Nama Provinsi">
                                </div>
                                <!-- Submit -->
