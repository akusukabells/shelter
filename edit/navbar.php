            ...
            <div id="longDashboard" class="hidden py-4 text-xs flex-col gap-4 text-white">
                ...
                <div class="mx-4 cursor-pointer">
                    ...
                    <div id="subMenuWilayah" class="h-0 overflow-hidden">
                        <div class="hover:bg-gray">
                            <a href="../public/provinsi.php" class="flex justify-between px-4 py-4">
                                <div class="flex">
                        ...
                        <div class="hover:bg-gray">
                            <a href="../public/kota_kabupaten.php" class="flex justify-between px-4 py-4">
                                <div class="flex">
                                    <div><i class="ml-1 w-7 text-[5px] fa-solid fa-circle"></i></div>
                ...
                <div class="mx-4 cursor-pointer">
                    ...
                    <div id="subMenuOrganisasi" class="h-0 overflow-hidden">
                        <div class="hover:bg-gray">
                            <a href="../public/kategori_organisasi.php" class="flex justify-between px-4 py-4">
                                <div class="flex">
                                    <div><i class="ml-1 w-7 text-[5px] fa-solid fa-circle"></i></div>
                        ...
                        <div class="hover:bg-gray">
                            <a href="../public/data_organisasi.php" class="flex justify-between px-4 py-4">
                                <div class="flex">
                                    <div><i class="ml-1 w-7 text-[5px] fa-solid fa-circle"></i></div>
                ...
                <div class="mx-4 cursor-pointer">
                    ...
                    <div id="subMenuKaryawan" class="h-0 overflow-hidden">
                        <div class="hover:bg-gray">
                            <a href="../public/karyawan.php" class="flex justify-between px-4 py-4">
                                <div class="flex">
                                    <div><i class="ml-1 w-7 text-[5px] fa-solid fa-circle"></i></div>
                        ...
                        <div class="hover:bg-gray">
                            <a href="../public/resetpassword.php" class="flex justify-between px-4 py-4">
                                <div class="flex">
                                    <div><i class="ml-1 w-7 text-[5px] fa-solid fa-circle"></i></div>
                        ...
                        <div class="hover:bg-gray">
                            <a href="../public/roles.php" class="flex justify-between px-4 py-4">
                                <div class="flex">
                                    <div><i class="ml-1 w-7 text-[5px] fa-solid fa-circle"></i></div>
                        ...
                        <div class="hover:bg-gray">
                            <a href="../public/menu.php" class="flex justify-between px-4 py-4">
                                <div class="flex">
                                    <div><i class="ml-1 w-7 text-[5px] fa-solid fa-circle"></i></div>
                        ...
                        <div class="hover:bg-gray">
                            <a href="../public/hakaksesmenu.php" class="flex justify-between px-4 py-4">
                                <div class="flex">
                                    <div><i class="ml-1 w-7 text-[5px] fa-solid fa-circle"></i></div>
                ...
                <div class="mx-4 cursor-pointer">
                    ...
                    <div id="subMenuManajemenAdmin" class="h-0 overflow-hidden">
                        <div class="hover:bg-gray">
                            <a href="../public/holidays.php" class="flex justify-between px-4 py-4">
                                <div class="flex">
                                    <div><i class="ml-1 w-7 text-[5px] fa-solid fa-circle"></i></div>
                        ...
                        <div class="hover:bg-gray">
                            <a href="../public/qrcode.php" class="flex justify-between px-4 py-4">
                                <div class="flex">
                                    <div><i class="ml-1 w-7 text-[5px] fa-solid fa-circle"></i></div>
                        ...
                        <div class="hover:bg-gray">
                            <a href="../public/statusbranch.php" class="flex justify-between px-4 py-4">
                                <div class="flex">
                                    <div><i class="ml-1 w-7 text-[5px] fa-solid fa-circle"></i></div>
                        ...
                        <div class="hover:bg-gray">
                            <a href="../public/endofdays.php" class="flex justify-between px-4 py-4">
                                <div class="flex">
                                    <div><i class="ml-1 w-7 text-[5px] fa-solid fa-circle"></i></div>
